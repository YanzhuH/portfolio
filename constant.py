...
info = {'brief':
        ...
        'location':'Atlanta, GA',
        'interest':'SWE, ML, AI',
        'skills':['Python','Java','Javascript','HTML & CSS','React','Streamlit','Docker','MongoDB','MySQL','AWS','Github','Figma'],
        }
...
# Contacts --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
phone = "470-652-3481"
email = "hyz0318@outlook.com"
linkedin_link = "www.linkedin.com/in/yanzhu-huang/"
github_link = "https://github.com/YanzhuH/"
